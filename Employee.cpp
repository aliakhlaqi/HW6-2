...
Employee::Employee(int hw, int sph, int wtd, int wd, string name, string id, Address address) : Person(name, id,address),
hourWork(hw),
salaryPerHour(sph),
workToDo(wtd),
workDone(wd) {}
...
ostream &operator<<(ostream &out, Employee &e) {
    ...
    out << "hour of Work: " << e.hourWork << endl << "salary per Hour: " << e.salaryPerHour << endl << "work to do: "
